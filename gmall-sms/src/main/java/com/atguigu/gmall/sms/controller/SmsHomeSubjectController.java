...
public class SmsHomeSubjectController {
    ...
    @GetMapping
    @ApiOperation("分页查询")
    public ResponseVo<PageResultVo> querySmsHomeSubjectByPage(PageParamVo paramVo){
        PageResultVo pageResultVo = smsHomeSubjectService.queryPage(paramVo);
    ...
    @GetMapping("{id}")
    @ApiOperation("详情查询")
    public ResponseVo<SmsHomeSubjectEntity> querySmsHomeSubjectById(@PathVariable("id") Long id){
		SmsHomeSubjectEntity smsHomeSubject = smsHomeSubjectService.getById(id);

        return ResponseVo.ok(smsHomeSubject);
    }
    ...
    @PostMapping
    @ApiOperation("保存")
    public ResponseVo<Object> save(@RequestBody SmsHomeSubjectEntity smsHomeSubject){
    ...
    @PostMapping("/update")
    @ApiOperation("修改")
    public ResponseVo update(@RequestBody SmsHomeSubjectEntity smsHomeSubject){
